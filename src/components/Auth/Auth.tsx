    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="flex justify-center">
          <img src="/logo_goalist.png" alt="Goalist" className="h-14 w-auto"/>
        </div>
        <div>
        ...
        {error && (
          <div className="bg-red-100 border border-red-400 text-sm text-red-700 px-3 py-2 rounded relative" role="alert">
