    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isSignUp) {
                ...
                setSuccessMessage("Please check your email to verify your account. You may need to check your spam folder.");
            } else {
            ...
            <div className="max-w-md w-full space-y-8">
                ...
                {successMessage && (
                    <div className="flex flex-col justify-center gap-4 items-center">
                        <div className="bg-green-100 border border-green-400 text-green-700 px-3 py-2 rounded" role="alert">
