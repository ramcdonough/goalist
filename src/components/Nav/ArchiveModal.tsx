        ...
        <div className="mb-4 relative">
          <div className="relative">
            <input 
              ...
              className="w-full p-2 pl-10 rounded-md dark:border-gray-700 bg-surface-light dark:bg-background-dark text-text-light dark:text-text-dark"
            />
              ...
              <div key={listId} className="border-b dark:border-gray-700 pb-2">
                ...
                <ul className="space-y-1">
                  {goals.map(goal => (
                    <li 
                      key={goal.id} 
                      className="flex items-center justify-between bg-surface-light dark:bg-background-dark p-1.5 rounded-md text-sm"
                    >
